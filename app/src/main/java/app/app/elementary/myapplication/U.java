...
public class U extends AppCompatActivity {
    ...
    private String word[] = {"ugly","umbrella","uncertain","uncle","under","uneasy","unhappy","unkind","unless","untie","upon","use","useful"};

    private String desc [] = {"feo(a)","paraguas","inseguro(a)","tío","debajo","incomodo(a)","infeliz","malo(a)","a no ser que","desatar","sobre","usar","útil"};
