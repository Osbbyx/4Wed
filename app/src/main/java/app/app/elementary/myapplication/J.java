...
public class J extends AppCompatActivity {
    ...
    private String word[] = {"jacket","jail","jam","joke","jolly","journey","joy","judge","juice","jump","just","just"};

    private String desc [] = {"chaqueta","cárcel","mermelada","chiste","alegre","viaje","alegría","juzgar","jugo","saltar","justamente","justo(a)"};
