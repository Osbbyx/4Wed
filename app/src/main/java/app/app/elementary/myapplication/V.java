...
public class V extends AppCompatActivity {
    ...
    private String word[] = {"vacant","vacation","valley","value","vase","vegetable","verse","very","view","village","vine","violin","visit","voice","vote"};

    private String desc [] = {"desocupado(a)","vacaciones","valle","valor","jarrón","vegetal","verso","muy","vista","aldea","plantas trepadoras","violín","visitar","voz","votar"};
